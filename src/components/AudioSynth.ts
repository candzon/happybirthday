...
export const birthdaySong: SongNote[] = [
  { note: "C4", dur: 0.35, lyric: "Hap-" },
  { note: "C4", dur: 0.15, lyric: "py" },
  { note: "D4", dur: 0.5, lyric: "Birth-" },
  { note: "C4", dur: 0.5, lyric: "day" },
  { note: "F4", dur: 0.5, lyric: "to" },
  { note: "E4", dur: 1.0, lyric: "you~ 💖" },
  ...
  { note: "D4", dur: 0.5, lyric: "Birth-" },
  { note: "C4", dur: 0.5, lyric: "day" },
  { note: "G4", dur: 0.5, lyric: "to" },
  { note: "F4", dur: 1.0, lyric: "you~ ✨" },
  { note: "REST", dur: 0.3, lyric: "" },

  { note: "C4", dur: 0.35, lyric: "Hap-" },
  { note: "C4", dur: 0.15, lyric: "py" },
  { note: "C5", dur: 0.5, lyric: "Birth-" },
  { note: "A4", dur: 0.5, lyric: "day" },
  { note: "F4", dur: 0.5, lyric: "Tuan" },
  { note: "E4", dur: 0.5, lyric: "Put-" },
  { note: "D4", dur: 1.0, lyric: "ri~ 👑" },
  { note: "REST", dur: 0.3, lyric: "" },

  { note: "Bb4", dur: 0.35, lyric: "Hap-" },
  { note: "Bb4", dur: 0.15, lyric: "py" },
  { note: "A4", dur: 0.5, lyric: "Birth-" },
  { note: "F4", dur: 0.5, lyric: "day" },
  { note: "G4", dur: 0.5, lyric: "to" },
  { note: "F4", dur: 1.2, lyric: "you!!! 🎂" },
